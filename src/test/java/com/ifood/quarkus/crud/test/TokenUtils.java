 ...
 * 
 * Peguei nesse endereço https://quarkus.io/guides/security-jwt
 */
public class TokenUtils {
	...
	public static String generateTokenString(final PrivateKey privateKey, final String kid, final String jsonResName,
